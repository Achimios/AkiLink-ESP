...
void readDataConfig() {  //      👁️    👁️    👁️    👁️    👁️    👁️    👁️
  ...
  // 设置串口指针
  switch (NUM_S_DATA) {
    case 0: S_DATA = &Serial; break;
    case 1: S_DATA = &Serial1; break;
    case 2: S_DATA = &Serial2; break;
    default:
      S_DATA = S_DATA;  // 双重保险
  ...
  switch (NUM_S_DEBUG) {
    case 0: S_DEBUG = &Serial; break;
    case 1: S_DEBUG = &Serial1; break;
    case 2: S_DEBUG = &Serial2; break;
    default:
